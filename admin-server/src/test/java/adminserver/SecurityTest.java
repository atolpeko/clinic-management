...
public class SecurityTest {
    ...
    private void shouldAllowAccessToAdminServerWhenUserIsAdmin() throws Exception {
    ...
    @Test
    @WithMockUser(authorities = { "INTERNAL", "TOP_MANAGER", "TEAM_MANAGER", "DOCTOR", "USER" })
    public void shouldDenyAccessToAdminServerWhenUserIsNotAdmin() throws Exception {
        getAndExpect(status().isForbidden());
    }

    @Test
    @WithAnonymousUser
    public void shouldDenyAccessToAdminServerWhenUserIsNotAuthenticated() throws Exception {
