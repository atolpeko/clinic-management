...
java -jar config-server/target/config-server-1.0-SNAPSHOT.jar > logs/config-server.log &
sleep 20
...
java -jar api-gateway/target/api-gateway-1.0-SNAPSHOT.jar > logs/api-gateway.log &
java -jar auth-server/target/auth-server-1.0-SNAPSHOT.jar > logs/auth-server.log &
java -jar client-service/target/client-service-1.0-SNAPSHOT.jar > logs/client-service.log &
